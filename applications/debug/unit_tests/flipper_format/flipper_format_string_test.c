...
MU_TEST_1(flipper_format_read_and_update_test, FlipperFormat* flipper_format) {
    ...
    mu_check(flipper_format_read_string(flipper_format, test_string_key, tmpstr));
    mu_assert_string_eq(test_string_updated_data, furry_string_get_cstr(tmpstr));
    ...
    mu_check(flipper_format_read_string(flipper_format, test_string_key, tmpstr));
    mu_assert_string_eq(test_string_updated_2_data, furry_string_get_cstr(tmpstr));
