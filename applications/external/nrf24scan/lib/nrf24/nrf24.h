...
#define nrf24_HANDLE &furry_hal_spi_bus_handle_external
 ...
 */
uint8_t
    nrf24_rxpacket(FurryHalSpiBusHandle* handle, uint8_t* packet, uint8_t* ret_packetsize, uint8_t packet_size_flag);
