...
void lfrfid_scene_delete_confirm_on_enter(void* context) {
    ...
    furry_string_printf(tmp_string, "Delete %s?", furry_string_get_cstr(app->file_name));
    widget_add_string_element(
        widget, 64, 0, AlignCenter, AlignTop, FontPrimary, furry_string_get_cstr(tmp_string));
    ...
    widget_add_string_element(
        widget, 64, 19, AlignCenter, AlignTop, FontSecondary, furry_string_get_cstr(tmp_string));
    widget_add_string_element(
        widget,
        64,
        49,
