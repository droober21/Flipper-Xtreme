...
void nfc_scene_nfc_data_info_on_enter(void* context) {
    ...
    if(nfc->dev->dev_name[0] != '\0') {
        furry_string_printf(temp_str, "\ec%s\n", nfc->dev->dev_name);
    }

    // Set tag type
    if(protocol == NfcDeviceProtocolEMV) {
        furry_string_cat_printf(temp_str, "\e#EMV Bank Card\n");
        ...
        furry_string_cat_printf(temp_str, "\e#MIFARE DESfire\n");
    } else if(protocol == NfcDeviceProtocolNfcV) {
        switch(dev_data->nfcv_data.sub_type) {
        case NfcVTypePlain:
            furry_string_cat_printf(temp_str, "\e#ISO15693\n");
            break;
        case NfcVTypeSlix:
            furry_string_cat_printf(temp_str, "\e#ISO15693 SLIX\n");
            break;
        case NfcVTypeSlixS:
            furry_string_cat_printf(temp_str, "\e#ISO15693 SLIX-S\n");
            break;
        case NfcVTypeSlixL:
            furry_string_cat_printf(temp_str, "\e#ISO15693 SLIX-L\n");
            break;
        case NfcVTypeSlix2:
            furry_string_cat_printf(temp_str, "\e#ISO15693 SLIX2\n");
            break;
        default:
            furry_string_cat_printf(temp_str, "\e#ISO15693 (unknown)\n");
            break;
        }
    } else {
        furry_string_cat_printf(temp_str, "\e#Unknown ISO tag\n");
    }
    ...
    if(protocol == NfcDeviceProtocolNfcV) {
        ...
        for(size_t i = 0; i < nfc_data->uid_len; i++) {
            furry_string_cat_printf(temp_str, " %02X", nfc_data->uid[i]);
        }
        ...
        furry_string_cat_printf(temp_str, "IC Ref: %02X\n", nfcv_data->ic_ref);
        furry_string_cat_printf(temp_str, "Blocks: %02X\n", nfcv_data->block_num);
        furry_string_cat_printf(temp_str, "Blocksize: %02X\n", nfcv_data->block_size);
        ...
        if(maxBlocks > 32) {
            maxBlocks = 32;
            furry_string_cat_printf(temp_str, "(truncated to %d blocks)\n", maxBlocks);
        }
        ...
        switch(dev_data->nfcv_data.sub_type) {
        case NfcVTypePlain:
            furry_string_cat_printf(temp_str, "Type: Plain\n");
            break;
        case NfcVTypeSlix:
            furry_string_cat_printf(temp_str, "Type: SLIX\n");
            furry_string_cat_printf(temp_str, "Keys:\n");
            furry_string_cat_printf(
                temp_str,
                " EAS      %08lX\n",
            ...
            break;
        case NfcVTypeSlixS:
            furry_string_cat_printf(temp_str, "Type: SLIX-S\n");
            furry_string_cat_printf(temp_str, "Keys:\n");
            furry_string_cat_printf(
                temp_str,
                " Read     %08lX\n",
            ...
            break;
        case NfcVTypeSlixL:
            furry_string_cat_printf(temp_str, "Type: SLIX-L\n");
            furry_string_cat_printf(temp_str, "Keys:\n");
            furry_string_cat_printf(
                temp_str,
                " Privacy  %08lX\n",
            ...
            break;
        case NfcVTypeSlix2:
            furry_string_cat_printf(temp_str, "Type: SLIX2\n");
            furry_string_cat_printf(temp_str, "Keys:\n");
            furry_string_cat_printf(
                temp_str,
                " Read     %08lX\n",
        ...
        char iso_type = FURRY_BIT(nfc_data->a_data.sak, 5) ? '4' : '3';
        ...
        furry_string_cat_printf(temp_str, " SAK: %02X", nfc_data->a_data.sak);
    }
    ...
    if(protocol == NfcDeviceProtocolMifareDesfire) {
        ...
        furry_string_cat_printf(temp_str, " bytes, %lu bytes free\n", bytes_free);
        ...
        furry_string_cat_printf(temp_str, "%d Application", n_apps);
        if(n_apps != 1) {
            furry_string_push_back(temp_str, 's');
        }
        furry_string_cat_printf(temp_str, ", %d file", n_files);
        if(n_files != 1) {
            furry_string_push_back(temp_str, 's');
        }
    } else if(protocol == NfcDeviceProtocolMifareUl) {
    ...
    widget_add_text_scroll_element(
        widget, 0, 0, 128, text_scroll_height, furry_string_get_cstr(temp_str));
