...
static void onewire_cli(Cli* cli, FurryString* args, void* context);
...
void onewire_cli(Cli* cli, FurryString* args, void* context) {
    UNUSED(context);
    FurryString* cmd;
    ...
    if(furry_string_cmp_str(cmd, "search") == 0) {
