...
static size_t rpc_debug_print_file_msg(
    ...
    for(size_t i = 0; i < msg_files_size; ++i, ++msg_file) {
        ...
        if(msg_file->name) {
            furry_string_cat_printf(str, " \'%s\'", msg_file->name);
        }
...
void rpc_debug_print_data(const char* prefix, uint8_t* buffer, size_t size) {
    ...
    furry_string_reserve(str, 100 + size * 5);

    furry_string_cat_printf(str, "\r\n%s DEC(%zu): {", prefix, size);
    for(size_t i = 0; i < size; ++i) {
        furry_string_cat_printf(str, "%d, ", buffer[i]);
    }
    furry_string_cat_printf(str, "}\r\n");

    printf("%s", furry_string_get_cstr(str));
    furry_string_reset(str);
    furry_string_reserve(str, 100 + size * 3);

    furry_string_cat_printf(str, "%s HEX(%zu): {", prefix, size);
    for(size_t i = 0; i < size; ++i) {
        furry_string_cat_printf(str, "%02X", buffer[i]);
    }
    furry_string_cat_printf(str, "}\r\n\r\n");
...
void rpc_debug_print_message(const PB_Main* message) {
    ...
    case PB_Main_storage_mkdir_request_tag:
        furry_string_cat_printf(str, "\tmkdir {\r\n");
        break;
    case PB_Main_storage_delete_request_tag: {
        furry_string_cat_printf(str, "\tdelete {\r\n");
    ...
    case PB_Main_empty_tag:
        furry_string_cat_printf(str, "\tempty {\r\n");
        break;
    case PB_Main_storage_info_request_tag: {
        furry_string_cat_printf(str, "\tinfo_request {\r\n");
    ...
    case PB_Main_storage_info_response_tag: {
        furry_string_cat_printf(str, "\tinfo_response {\r\n");
        furry_string_cat_printf(
    ...
    case PB_Main_storage_stat_request_tag: {
        furry_string_cat_printf(str, "\tstat_request {\r\n");
    ...
    case PB_Main_storage_stat_response_tag: {
        furry_string_cat_printf(str, "\tstat_response {\r\n");
    ...
    case PB_Main_storage_list_request_tag: {
        furry_string_cat_printf(str, "\tlist_request {\r\n");
    ...
    case PB_Main_storage_read_request_tag: {
        furry_string_cat_printf(str, "\tread_request {\r\n");
    ...
    case PB_Main_storage_write_request_tag: {
        furry_string_cat_printf(str, "\twrite_request {\r\n");
    ...
    case PB_Main_storage_read_response_tag:
        furry_string_cat_printf(str, "\tread_response {\r\n");
    ...
    case PB_Main_gui_start_screen_stream_request_tag:
        furry_string_cat_printf(str, "\tstart_screen_stream {\r\n");
        break;
    case PB_Main_gui_stop_screen_stream_request_tag:
        furry_string_cat_printf(str, "\tstop_screen_stream {\r\n");
        break;
    case PB_Main_gui_screen_frame_tag:
        furry_string_cat_printf(str, "\tscreen_frame {\r\n");
        break;
    case PB_Main_gui_send_input_event_request_tag:
        furry_string_cat_printf(str, "\tsend_input_event {\r\n");
        furry_string_cat_printf(
    ...
    case PB_Main_gui_start_virtual_display_request_tag:
        furry_string_cat_printf(str, "\tstart_virtual_display {\r\n");
        break;
    case PB_Main_gui_stop_virtual_display_request_tag:
        furry_string_cat_printf(str, "\tstop_virtual_display {\r\n");
        break;
    }
    furry_string_cat_printf(str, "\t}\r\n}\r\n");
    printf("%s", furry_string_get_cstr(str));
