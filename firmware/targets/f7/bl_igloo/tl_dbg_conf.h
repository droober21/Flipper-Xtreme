...
#define TL_SHCI_CMD_DBG_RAW(_PDATA_, _SIZE_) furry_hal_console_tx_with_new_line(_PDATA_, _SIZE_)
#else
...
#define TL_SHCI_EVT_DBG_RAW(_PDATA_, _SIZE_) furry_hal_console_tx_with_new_line(_PDATA_, _SIZE_)
#else
...
#define TL_HCI_CMD_DBG_RAW(_PDATA_, _SIZE_) furry_hal_console_tx_with_new_line(_PDATA_, _SIZE_)
#else
...
#define TL_HCI_EVT_DBG_RAW(_PDATA_, _SIZE_) furry_hal_console_tx_with_new_line(_PDATA_, _SIZE_)
#else
