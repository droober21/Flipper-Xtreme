...
typedef struct {
    ...
    uint8_t uid[10];
    union {
        FurryHalNfcADevData a_data;
        FurryHalNfcFDevData f_data;
    };
} FurryHalNfcDevData;
...
#define FURRY_HAL_NFC_LL_GT_NFCA furry_hal_nfc_ll_ms2fc(5U) /*!< GTA  Digital 2.0  6.10.4.1 & B.2 */
#define FURRY_HAL_NFC_LL_GT_NFCB furry_hal_nfc_ll_ms2fc(5U) /*!< GTB  Digital 2.0  7.9.4.1  & B.3 */
#define FURRY_HAL_NFC_LL_GT_NFCF furry_hal_nfc_ll_ms2fc(20U) /*!< GTF  Digital 2.0  8.7.4.1  & B.4 */
#define FURRY_HAL_NFC_LL_GT_NFCV furry_hal_nfc_ll_ms2fc(5U) /*!< GTV  Digital 2.0  9.7.5.1  & B.5 */
...
#define FURRY_HAL_NFC_LL_FDT_POLL_NFCF_POLLER 6800U /*!< FDTF,POLL,MIN   Digital 2.1  8.7.3 & B.4 */
...
// TODO rework all pollers with furry_hal_nfc_ll_txrx_bits
