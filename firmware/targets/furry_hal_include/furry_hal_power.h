...
/** Power IC type */
typedef enum {
    FurryHalPowerICCharger,
    FurryHalPowerICFuelGauge,
} FurryHalPowerIC;
 ...
 *
 * @param      ic    FurryHalPowerIc to get measurment
 *
 * @return     voltage in V
 */
 ...
 */
void furry_hal_power_info_get(PropertyValueCallback callback, char sep, void* context);
 ...
 * @param[in]  context      context to pass to callback
 */
void furry_hal_power_debug_get(PropertyValueCallback callback, void* context);
