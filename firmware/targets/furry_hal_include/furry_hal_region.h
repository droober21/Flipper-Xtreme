 ...
 *
 * @return     pointer to FurryHalRegion instance (in RAM or Flash, check before freeing on region update)
 */
const FurryHalRegion* furry_hal_region_get();

/** Set device region data
 *
 * @param      region  pointer to the FurryHalRegion
 */
