/**
 * @file memmgr_heap.h
 * Furry: heap memory management API and allocator
 */
 ...
 */
void memmgr_heap_enable_thread_trace(FurryThreadId taks_handle);

/** Memmgr heap disable thread allocation tracking
 *
 * @param      thread_id  - thread id to track
 */
void memmgr_heap_disable_thread_trace(FurryThreadId taks_handle);
 ...
 */
size_t memmgr_heap_get_thread_memory(FurryThreadId taks_handle);
