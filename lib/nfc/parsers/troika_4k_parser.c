...
bool troika_4k_parser_verify(NfcWorker* nfc_worker, FurryHalNfcTxRxContext* tx_rx) {
...
bool troika_4k_parser_read(NfcWorker* nfc_worker, FurryHalNfcTxRxContext* tx_rx) {
    furry_assert(nfc_worker);
