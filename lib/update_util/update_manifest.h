...
typedef struct {
    ...
    FurryString* version;
    uint32_t target;
    FurryString* staged_loader_file;
    uint32_t staged_loader_crc;
    FurryString* firmware_dfu_image;
    FurryString* radio_image;
    uint32_t radio_address;
    UpdateManifestRadioVersion radio_version;
    uint32_t radio_crc;
    FurryString* resource_bundle;
    FurryHalFlashRawOptionByteData ob_reference;
    FurryHalFlashRawOptionByteData ob_compare_mask;
    FurryHalFlashRawOptionByteData ob_write_mask;
    FurryString* splash_file;
    bool valid;
} UpdateManifest;
